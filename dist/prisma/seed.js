...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var password, hashedPassword, result, error_1;
...
main()
    .then(function () { return console.log('Seed completed successfully'); })
    .catch(function (e) { return console.error('Fatal seed error:', e); });
